...
- предоставление краткой информации о карте ( название аркана, категория, значение в
  прямом/перевернутом положении)
- предоставление подробной информации о карте (общее значение, значение в любви и отношениях, в
  ситуации и вопросе, значение карты дня, совет карты, значение да/нет)
